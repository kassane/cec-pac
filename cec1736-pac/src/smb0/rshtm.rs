...
#[doc = "Field `RSHTM` reader - This is the value of the timing requirement tHd:Sta in the I2C specification for a repeated START bit. This is used to hold the clock until the Hold Time for the repeated Start Bit has been satisfied."]
pub type RSHTM_R = crate::FieldReader<u8, u8>;
#[doc = "Field `RSHTM` writer - This is the value of the timing requirement tHd:Sta in the I2C specification for a repeated START bit. This is used to hold the clock until the Hold Time for the repeated Start Bit has been satisfied."]
pub type RSHTM_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RSHTM_SPEC, u8, u8, 8, O>;
impl R {
    #[doc = "Bits 0:7 - This is the value of the timing requirement tHd:Sta in the I2C specification for a repeated START bit. This is used to hold the clock until the Hold Time for the repeated Start Bit has been satisfied."]
    #[inline(always)]
