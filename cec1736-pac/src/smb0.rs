...
pub struct RegisterBlock {
    ...
    #[doc = "0x04 - Own Address Register Note that the Data Register and Own Address fields are offset by one bit, so that programming Own Address 1 with a value of 55h will result in the value AAh being recognized as the SMB Controller Core slave address."]
    ...
    pub rshtm: RSHTM,
    #[doc = "0x1c - Extended Length Register"]
    pub extnd_len: EXTND_LEN,
    ...
    _reserved29: [u8; 0x03],
    #[doc = "0x7c - This is the I2C Shadow Data Register"]
    pub shdw_data: SHDW_DATA,
}
impl RegisterBlock {
...
pub mod rshtm;
#[doc = "EXTND_LEN (r) register accessor: an alias for `Reg<EXTND_LEN_SPEC>`"]
pub type EXTND_LEN = crate::Reg<extnd_len::EXTND_LEN_SPEC>;
...
pub mod prm_ctrl;
#[doc = "SHDW_DATA (rw) register accessor: an alias for `Reg<SHDW_DATA_SPEC>`"]
pub type SHDW_DATA = crate::Reg<shdw_data::SHDW_DATA_SPEC>;
