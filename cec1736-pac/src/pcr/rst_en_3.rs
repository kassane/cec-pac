...
#[doc = "Field `LED1_RST_EN` reader - LED1 Reset Enable (LED1_RST_EN)"]
pub type LED1_RST_EN_R = crate::BitReader<bool>;
#[doc = "Field `LED1_RST_EN` writer - LED1 Reset Enable (LED1_RST_EN)"]
...
#[doc = "Field `CRYPTO_RST_EN` reader - CRYPTO Reset Enable"]
pub type CRYPTO_RST_EN_R = crate::BitReader<bool>;
#[doc = "Field `CRYPTO_RST_EN` writer - CRYPTO Reset Enable"]
pub type CRYPTO_RST_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, RST_EN_3_SPEC, bool, O>;
...
impl R {
    ...
    #[doc = "Bit 17 - LED1 Reset Enable (LED1_RST_EN)"]
    #[inline(always)]
    ...
    #[doc = "Bit 26 - CRYPTO Reset Enable"]
    #[inline(always)]
    pub fn crypto_rst_en(&self) -> CRYPTO_RST_EN_R {
        CRYPTO_RST_EN_R::new(((self.bits >> 26) & 1) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 26 - CRYPTO Reset Enable"]
    #[inline(always)]
    pub fn crypto_rst_en(&mut self) -> CRYPTO_RST_EN_W<26> {
        CRYPTO_RST_EN_W::new(self)
    }
    #[doc = "Bit 29 - Hibernation TIMER 1 Reset Enable (HTM_1_RST_EN)"]
    #[inline(always)]
