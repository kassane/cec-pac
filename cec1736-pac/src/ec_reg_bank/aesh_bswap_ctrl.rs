...
pub type OP_BYTE_SWAP_EN_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, AESH_BSWAP_CTRL_SPEC, bool, O>;
#[doc = "Field `IP_BLK_SWAP_EN` reader - Used to enable word swap on a DWORD during AHB read from AES / HASH block 0=Disable."]
...
pub enum IP_BLK_SWAP_ENSELECT_A {
    ...
    #[doc = "3: 3=Swap doublewords in 64-byte blocks. Useful for SHA-256. Bus references issued in the order 0x3C, 0x38, 0x34, 0x30, 0x2C, 0x28, 0x24, 0x20, 0x1C, 0x18, 0x14, 0x10, 0xC, 0x8, 0x4, 0x0,..."]
    ...
    #[doc = "1: 1=Swap doublewords in 8-byte blocks. Useful for SHA-512, which works on 64-bit words. Bus references issued in the order 0x4, 0x0, 0xC, 0x8, ..."]
    SWAP_8_BYTE_BLOCK = 1,
    #[doc = "0: 0=Disable."]
    DIS = 0,
}
...
#[doc = "Field `IP_BLK_SWAP_EN` writer - Used to enable word swap on a DWORD during AHB read from AES / HASH block 0=Disable."]
...
#[doc = "Field `OP_BLK_SWAP_EN` reader - Used to enable word swap on a DWORD during AHB write from AES / HASH block 0=Disable."]
...
#[doc = "Field `OP_BLK_SWAP_EN` writer - Used to enable word swap on a DWORD during AHB write from AES / HASH block 0=Disable."]
...
impl R {
    ...
    #[doc = "Bits 2:4 - Used to enable word swap on a DWORD during AHB read from AES / HASH block 0=Disable."]
    #[inline(always)]
    pub fn ip_blk_swap_en(&self) -> IP_BLK_SWAP_EN_R {
        IP_BLK_SWAP_EN_R::new(((self.bits >> 2) & 7) as u8)
    }
    #[doc = "Bits 5:7 - Used to enable word swap on a DWORD during AHB write from AES / HASH block 0=Disable."]
    #[inline(always)]
