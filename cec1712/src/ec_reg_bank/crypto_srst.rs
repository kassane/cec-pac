...
#[doc = "Field `RNG` reader - When this bit is asserted ('1'), the Random Number Generator block is reset."]
pub type RNG_R = crate::BitReader<bool>;
#[doc = "Field `RNG` writer - When this bit is asserted ('1'), the Random Number Generator block is reset."]
pub type RNG_W<'a, const O: u8> = crate::BitWriter<'a, u32, CRYPTO_SRST_SPEC, bool, O>;
#[doc = "Field `PUB_KEY` reader - When this bit is asserted ('1'), the Public Key block is reset."]
pub type PUB_KEY_R = crate::BitReader<bool>;
#[doc = "Field `PUB_KEY` writer - When this bit is asserted ('1'), the Public Key block is reset."]
pub type PUB_KEY_W<'a, const O: u8> = crate::BitWriter<'a, u32, CRYPTO_SRST_SPEC, bool, O>;
#[doc = "Field `AES_HASH` reader - When this bit is asserted ('1'), the AES and Hash blocks are reset."]
pub type AES_HASH_R = crate::BitReader<bool>;
#[doc = "Field `AES_HASH` writer - When this bit is asserted ('1'), the AES and Hash blocks are reset."]
pub type AES_HASH_W<'a, const O: u8> = crate::BitWriter<'a, u32, CRYPTO_SRST_SPEC, bool, O>;
impl R {
    ...
    #[inline(always)]
    pub fn pub_key(&self) -> PUB_KEY_R {
        PUB_KEY_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - When this bit is asserted ('1'), the AES and Hash blocks are reset."]
    #[inline(always)]
    pub fn aes_hash(&self) -> AES_HASH_R {
        AES_HASH_R::new(((self.bits >> 2) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - When this bit is asserted ('1'), the Random Number Generator block is reset."]
    ...
    #[doc = "Bit 1 - When this bit is asserted ('1'), the Public Key block is reset."]
    #[inline(always)]
    pub fn pub_key(&mut self) -> PUB_KEY_W<1> {
        PUB_KEY_W::new(self)
    }
    #[doc = "Bit 2 - When this bit is asserted ('1'), the AES and Hash blocks are reset."]
    #[inline(always)]
    pub fn aes_hash(&mut self) -> AES_HASH_W<2> {
        AES_HASH_W::new(self)
    }
