...
impl DIV_R {
    ...
    pub fn variant(&self) -> Option<DIVSELECT_A> {
        match self.bits {
            ...
            3 => Some(DIVSELECT_A::DIVIDE_BY_3),
    ...
    #[doc = "Checks if the value of the field is `DIVIDE_BY_3`"]
    #[inline(always)]
    pub fn is_divide_by_3(&self) -> bool {
        *self == DIVSELECT_A::DIVIDE_BY_3
    }
...
impl<'a, const O: u8> DIV_W<'a, O> {
    ...
    #[inline(always)]
    pub fn divide_by_3(self) -> &'a mut W {
        self.variant(DIVSELECT_A::DIVIDE_BY_3)
    }
