...
pub type VCI_IN_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CTRL_STS_SPEC, u8, u8, 4, O>;
#[doc = "Field `VCI_OUT_GPIO_SEL` reader - This bit selects the power source for GPIO outputs.\n 1= GPIO will be powered by VBAT power well (VCI_OUT functionality).\n 0= GPIO will be powered by VTR power well.\n"]
pub type VCI_OUT_GPIO_SEL_R = crate::BitReader<bool>;
#[doc = "Field `VCI_OUT_GPIO_SEL` writer - This bit selects the power source for GPIO outputs.\n 1= GPIO will be powered by VBAT power well (VCI_OUT functionality).\n 0= GPIO will be powered by VTR power well.\n"]
pub type VCI_OUT_GPIO_SEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL_STS_SPEC, bool, O>;
...
#[doc = "Field `WK_ALRM` reader - If enabled by WEEK_ALRM_LE, this bit is set to 1 if the Week Alarm signal is asserted. It is reset by writes to WEEK_ALRM_LS."]
pub type WK_ALRM_R = crate::BitReader<bool>;
#[doc = "Field `WK_ALRM` writer - If enabled by WEEK_ALRM_LE, this bit is set to 1 if the Week Alarm signal is asserted. It is reset by writes to WEEK_ALRM_LS."]
...
#[doc = "Field `SYSPWR_PRES` reader - This is the System power present select bit.\n 1= VCI_IN3 is used as System power present.\n 0= VCI_IN3 is used as VCI_IN3.\n"]
pub type SYSPWR_PRES_R = crate::BitReader<bool>;
#[doc = "Field `SYSPWR_PRES` writer - This is the System power present select bit.\n 1= VCI_IN3 is used as System power present.\n 0= VCI_IN3 is used as VCI_IN3.\n"]
pub type SYSPWR_PRES_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL_STS_SPEC, bool, O>;
impl R {
    #[doc = "Bits 0:3 - These bits provide the latched state of the associated VCI_IN# pin, if latching is enabled or the current state of the pin\n if latching is not enabled. In both cases, the value is determined after the action of the VCI Polarity Register.\n Note: The VCI_IN\\[6:0\\]# bits default to the state of their respective input pins."]
    #[inline(always)]
    pub fn vci_in(&self) -> VCI_IN_R {
        VCI_IN_R::new((self.bits & 0x0f) as u8)
    }
    #[doc = "Bit 7 - This bit selects the power source for GPIO outputs.\n 1= GPIO will be powered by VBAT power well (VCI_OUT functionality).\n 0= GPIO will be powered by VTR power well.\n"]
    #[inline(always)]
    pub fn vci_out_gpio_sel(&self) -> VCI_OUT_GPIO_SEL_R {
        VCI_OUT_GPIO_SEL_R::new(((self.bits >> 7) & 1) != 0)
    }
    ...
    #[doc = "Bit 16 - If enabled by WEEK_ALRM_LE, this bit is set to 1 if the Week Alarm signal is asserted. It is reset by writes to WEEK_ALRM_LS."]
    #[inline(always)]
    ...
    #[doc = "Bit 18 - This is the System power present select bit.\n 1= VCI_IN3 is used as System power present.\n 0= VCI_IN3 is used as VCI_IN3.\n"]
    #[inline(always)]
    pub fn syspwr_pres(&self) -> SYSPWR_PRES_R {
        SYSPWR_PRES_R::new(((self.bits >> 18) & 1) != 0)
    }
}
impl W {
    #[doc = "Bits 0:3 - These bits provide the latched state of the associated VCI_IN# pin, if latching is enabled or the current state of the pin\n if latching is not enabled. In both cases, the value is determined after the action of the VCI Polarity Register.\n Note: The VCI_IN\\[6:0\\]# bits default to the state of their respective input pins."]
    ...
    #[doc = "Bit 7 - This bit selects the power source for GPIO outputs.\n 1= GPIO will be powered by VBAT power well (VCI_OUT functionality).\n 0= GPIO will be powered by VTR power well.\n"]
    #[inline(always)]
    pub fn vci_out_gpio_sel(&mut self) -> VCI_OUT_GPIO_SEL_W<7> {
        VCI_OUT_GPIO_SEL_W::new(self)
    }
    #[doc = "Bit 8 - This bit provides the current status of the VCI_OVRD_IN pin.\n Note: The VCI_OVRD_IN bit defaults to the state of the respective input pin."]
    #[inline(always)]
    ...
    #[doc = "Bit 18 - This is the System power present select bit.\n 1= VCI_IN3 is used as System power present.\n 0= VCI_IN3 is used as VCI_IN3.\n"]
    #[inline(always)]
    pub fn syspwr_pres(&mut self) -> SYSPWR_PRES_W<18> {
        SYSPWR_PRES_W::new(self)
    }
...
#[doc = "`reset()` method sets CTRL_STS to value 0x80"]
