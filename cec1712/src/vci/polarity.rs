...
pub type VCI_IN_W<'a, const O: u8> = crate::FieldWriter<'a, u32, POLARITY_SPEC, u8, u8, 4, O>;
impl R {
    #[doc = "Bits 0:3 - These bits determine the polarity of the VCI_IN input signals: For each bit in the field:\n 1=Active High. The value on the pins is inverted before use\n 0=Active Low (default)."]
    #[inline(always)]
