...
#[doc = "Field `STRT_SIN` reader - (START_SINGLE) 0: The ADC Single Mode is disabled. 1: The ADC Single Mode is enabled. Note: This bit is self-clearing"]
pub type STRT_SIN_R = crate::BitReader<bool>;
#[doc = "Field `STRT_SIN` writer - (START_SINGLE) 0: The ADC Single Mode is disabled. 1: The ADC Single Mode is enabled. Note: This bit is self-clearing"]
...
#[doc = "Field `SFT_RST` reader - (SOFT_RESET) 1: writing one causes a reset of the ADC block hardware (not the registers) 0: writing zero takes the ADC block out of reset"]
pub type SFT_RST_R = crate::BitReader<bool>;
#[doc = "Field `SFT_RST` writer - (SOFT_RESET) 1: writing one causes a reset of the ADC block hardware (not the registers) 0: writing zero takes the ADC block out of reset"]
...
impl R {
    ...
    #[doc = "Bit 1 - (START_SINGLE) 0: The ADC Single Mode is disabled. 1: The ADC Single Mode is enabled. Note: This bit is self-clearing"]
    #[inline(always)]
    ...
    #[doc = "Bit 4 - (SOFT_RESET) 1: writing one causes a reset of the ADC block hardware (not the registers) 0: writing zero takes the ADC block out of reset"]
    #[inline(always)]
...
#[doc = "`reset()` method sets CTRL to value 0x0001_0106"]
