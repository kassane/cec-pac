...
#[doc = "Field `ACK_NAK` reader - This is the Promiscuous ACK / NAK response register.\n 1= ACK. \n 0= NAK. \n"]
pub type ACK_NAK_R = crate::BitReader<bool>;
#[doc = "Field `ACK_NAK` writer - This is the Promiscuous ACK / NAK response register.\n 1= ACK. \n 0= NAK. \n"]
pub type ACK_NAK_W<'a, const O: u8> = crate::BitWriter<'a, u8, PRM_CTRL_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0 - This is the Promiscuous ACK / NAK response register.\n 1= ACK. \n 0= NAK. \n"]
    #[inline(always)]
