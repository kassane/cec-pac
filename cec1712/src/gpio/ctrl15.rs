...
pub type PU_PD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CTRL15_SPEC, u8, u8, 2, O>;
...
pub type MUX_CTRL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CTRL15_SPEC, u8, u8, 3, O>;
