...
#[doc = "Field `COMP_0` reader - A COMPARE 0 interrupt is generated when this register matches the value in the Free Running Timer."]
pub type COMP_0_R = crate::FieldReader<u32, u32>;
#[doc = "Field `COMP_0` writer - A COMPARE 0 interrupt is generated when this register matches the value in the Free Running Timer."]
pub type COMP_0_W<'a, const O: u8> = crate::FieldWriter<'a, u32, COMP0_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - A COMPARE 0 interrupt is generated when this register matches the value in the Free Running Timer."]
    #[inline(always)]
    pub fn comp_0(&self) -> COMP_0_R {
        COMP_0_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - A COMPARE 0 interrupt is generated when this register matches the value in the Free Running Timer."]
    #[inline(always)]
    pub fn comp_0(&mut self) -> COMP_0_W<0> {
        COMP_0_W::new(self)
    }
