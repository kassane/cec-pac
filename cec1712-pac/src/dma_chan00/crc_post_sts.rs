...
#[doc = "Field `CRC_DONE` reader - This bit is set to '1b' when the CRC calculation has completed from either normal or forced termination.\n It is cleared to '0b' when the DMA controller starts a new transfer on the channel."]
pub type CRC_DONE_R = crate::BitReader<bool>;
#[doc = "Field `CRC_DONE` writer - This bit is set to '1b' when the CRC calculation has completed from either normal or forced termination.\n It is cleared to '0b' when the DMA controller starts a new transfer on the channel."]
pub type CRC_DONE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CRC_POST_STS_SPEC, bool, O>;
#[doc = "Field `CRC_RUNNING` reader - This bit is set to '1b' when the DMA controller starts the post-transfer transmission of the CRC.\n It is only set when the post-transfer is enabled by the CRC_POST_TRANSFER_ENABLE field. This bit is cleared\n to '0b' when the post-transfer completes."]
pub type CRC_RUNNING_R = crate::BitReader<bool>;
#[doc = "Field `CRC_RUNNING` writer - This bit is set to '1b' when the DMA controller starts the post-transfer transmission of the CRC.\n It is only set when the post-transfer is enabled by the CRC_POST_TRANSFER_ENABLE field. This bit is cleared\n to '0b' when the post-transfer completes."]
pub type CRC_RUNNING_W<'a, const O: u8> = crate::BitWriter<'a, u32, CRC_POST_STS_SPEC, bool, O>;
#[doc = "Field `CRC_DATA_DONE` reader - This bit is set to '1b' when the DMA controller has completed the post-transfer of the CRC data.\n This bit is cleared to '0b' when the a new DMA transfer starts."]
pub type CRC_DATA_DONE_R = crate::BitReader<bool>;
#[doc = "Field `CRC_DATA_DONE` writer - This bit is set to '1b' when the DMA controller has completed the post-transfer of the CRC data.\n This bit is cleared to '0b' when the a new DMA transfer starts."]
pub type CRC_DATA_DONE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CRC_POST_STS_SPEC, bool, O>;
#[doc = "Field `CRC_DATA_READY` reader - This bit is set to '1b' when the DMA controller is processing the post-transfer of the CRC data.\n This bit is cleared to '0b' when the post-transfer completes."]
pub type CRC_DATA_READY_R = crate::BitReader<bool>;
#[doc = "Field `CRC_DATA_READY` writer - This bit is set to '1b' when the DMA controller is processing the post-transfer of the CRC data.\n This bit is cleared to '0b' when the post-transfer completes."]
...
impl R {
    ...
    #[doc = "Bit 2 - This bit is set to '1b' when the DMA controller has completed the post-transfer of the CRC data.\n This bit is cleared to '0b' when the a new DMA transfer starts."]
    #[inline(always)]
    pub fn crc_data_done(&self) -> CRC_DATA_DONE_R {
        CRC_DATA_DONE_R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - This bit is set to '1b' when the DMA controller is processing the post-transfer of the CRC data.\n This bit is cleared to '0b' when the post-transfer completes."]
    #[inline(always)]
