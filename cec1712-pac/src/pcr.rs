...
Processor Clock Divide Value (PROC_DIV)"]
    ...
    #[doc = "0x84 - LOCK Register"]
    pub lock_reg: LOCK_REG,
}
...
pub mod rst_en_4;
#[doc = "LOCK_REG (rw) register accessor: an alias for `Reg<LOCK_REG_SPEC>`"]
pub type LOCK_REG = crate::Reg<lock_reg::LOCK_REG_SPEC>;
#[doc = "LOCK Register"]
pub mod lock_reg;
