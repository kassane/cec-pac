...
#[doc = "Field `SADDR` reader - This register stores the value of the Slave Address and Direction Bit from the 1st byte of a Slave transfer.\n This is loaded immediately upon receipt of the address byte, before the ACK/NAK 9th clock. \n"]
pub type SADDR_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SADDR` writer - This register stores the value of the Slave Address and Direction Bit from the 1st byte of a Slave transfer.\n This is loaded immediately upon receipt of the address byte, before the ACK/NAK 9th clock. \n"]
pub type SADDR_W<'a, const O: u8> = crate::FieldWriter<'a, u8, SLV_ADDR_SPEC, u8, u8, 8, O>;
impl R {
    #[doc = "Bits 0:7 - This register stores the value of the Slave Address and Direction Bit from the 1st byte of a Slave transfer.\n This is loaded immediately upon receipt of the address byte, before the ACK/NAK 9th clock. \n"]
    #[inline(always)]
