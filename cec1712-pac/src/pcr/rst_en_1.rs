...
#[doc = "Field `TACH0_RST_EN` reader - TACH0 Reset Enable (TACH0_RST_EN)"]
pub type TACH0_RST_EN_R = crate::BitReader<bool>;
#[doc = "Field `TACH0_RST_EN` writer - TACH0 Reset Enable (TACH0_RST_EN)"]
...
#[doc = "Field `TACH2_RST_EN` reader - TACH2 Reset Enable (TACH2_RST_EN)"]
pub type TACH2_RST_EN_R = crate::BitReader<bool>;
#[doc = "Field `TACH2_RST_EN` writer - TACH2 Reset Enable (TACH2_RST_EN)"]
pub type TACH2_RST_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, RST_EN_1_SPEC, bool, O>;
#[doc = "Field `PWM1_RST_EN` reader - PWM1 Reset Enable (PWM1_RST_EN)"]
pub type PWM1_RST_EN_R = crate::BitReader<bool>;
#[doc = "Field `PWM1_RST_EN` writer - PWM1 Reset Enable (PWM1_RST_EN)"]
pub type PWM1_RST_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, RST_EN_1_SPEC, bool, O>;
#[doc = "Field `PWM4_RST_EN` reader - PWM4 Reset Enable (PWM4_RST_EN)"]
pub type PWM4_RST_EN_R = crate::BitReader<bool>;
#[doc = "Field `PWM4_RST_EN` writer - PWM4 Reset Enable (PWM4_RST_EN)"]
pub type PWM4_RST_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, RST_EN_1_SPEC, bool, O>;
#[doc = "Field `PWM6_RST_EN` reader - PWM6 Reset Enable (PWM6_RST_EN)"]
pub type PWM6_RST_EN_R = crate::BitReader<bool>;
#[doc = "Field `PWM6_RST_EN` writer - PWM6 Reset Enable (PWM6_RST_EN)"]
pub type PWM6_RST_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, RST_EN_1_SPEC, bool, O>;
#[doc = "Field `PWM7_RST_EN` reader - PWM7 Reset Enable (PWM7_RST_EN)"]
pub type PWM7_RST_EN_R = crate::BitReader<bool>;
#[doc = "Field `PWM7_RST_EN` writer - PWM7 Reset Enable (PWM7_RST_EN)"]
pub type PWM7_RST_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, RST_EN_1_SPEC, bool, O>;
#[doc = "Field `TMR16_0_RST_EN` reader - TIMER16_0 Reset Enable (TIMER16_0_RST_EN)"]
pub type TMR16_0_RST_EN_R = crate::BitReader<bool>;
#[doc = "Field `TMR16_0_RST_EN` writer - TIMER16_0 Reset Enable (TIMER16_0_RST_EN)"]
pub type TMR16_0_RST_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, RST_EN_1_SPEC, bool, O>;
#[doc = "Field `TMR16_1_RST_EN` reader - TIMER16_1 Reset Enable (TIMER16_1_RST_EN)"]
pub type TMR16_1_RST_EN_R = crate::BitReader<bool>;
#[doc = "Field `TMR16_1_RST_EN` writer - TIMER16_1 Reset Enable (TIMER16_1_RST_EN)"]
...
impl R {
    ...
    #[doc = "Bit 2 - TACH0 Reset Enable (TACH0_RST_EN)"]
    #[inline(always)]
    ...
    #[doc = "Bit 12 - TACH2 Reset Enable (TACH2_RST_EN)"]
    #[inline(always)]
    pub fn tach2_rst_en(&self) -> TACH2_RST_EN_R {
        TACH2_RST_EN_R::new(((self.bits >> 12) & 1) != 0)
    }
    #[doc = "Bit 20 - PWM1 Reset Enable (PWM1_RST_EN)"]
    #[inline(always)]
    pub fn pwm1_rst_en(&self) -> PWM1_RST_EN_R {
        PWM1_RST_EN_R::new(((self.bits >> 20) & 1) != 0)
    }
    #[doc = "Bit 23 - PWM4 Reset Enable (PWM4_RST_EN)"]
    #[inline(always)]
    pub fn pwm4_rst_en(&self) -> PWM4_RST_EN_R {
        PWM4_RST_EN_R::new(((self.bits >> 23) & 1) != 0)
    }
    #[doc = "Bit 25 - PWM6 Reset Enable (PWM6_RST_EN)"]
    #[inline(always)]
    pub fn pwm6_rst_en(&self) -> PWM6_RST_EN_R {
        PWM6_RST_EN_R::new(((self.bits >> 25) & 1) != 0)
    }
    #[doc = "Bit 26 - PWM7 Reset Enable (PWM7_RST_EN)"]
    #[inline(always)]
    pub fn pwm7_rst_en(&self) -> PWM7_RST_EN_R {
        PWM7_RST_EN_R::new(((self.bits >> 26) & 1) != 0)
    }
    #[doc = "Bit 30 - TIMER16_0 Reset Enable (TIMER16_0_RST_EN)"]
    #[inline(always)]
    pub fn tmr16_0_rst_en(&self) -> TMR16_0_RST_EN_R {
        TMR16_0_RST_EN_R::new(((self.bits >> 30) & 1) != 0)
    }
    #[doc = "Bit 31 - TIMER16_1 Reset Enable (TIMER16_1_RST_EN)"]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bit 12 - TACH2 Reset Enable (TACH2_RST_EN)"]
    #[inline(always)]
    pub fn tach2_rst_en(&mut self) -> TACH2_RST_EN_W<12> {
        TACH2_RST_EN_W::new(self)
    }
    #[doc = "Bit 20 - PWM1 Reset Enable (PWM1_RST_EN)"]
    #[inline(always)]
    ...
    #[doc = "Bit 25 - PWM6 Reset Enable (PWM6_RST_EN)"]
    #[inline(always)]
    pub fn pwm6_rst_en(&mut self) -> PWM6_RST_EN_W<25> {
        PWM6_RST_EN_W::new(self)
    }
    #[doc = "Bit 26 - PWM7 Reset Enable (PWM7_RST_EN)"]
    #[inline(always)]
    pub fn pwm7_rst_en(&mut self) -> PWM7_RST_EN_W<26> {
        PWM7_RST_EN_W::new(self)
    }
    #[doc = "Bit 30 - TIMER16_0 Reset Enable (TIMER16_0_RST_EN)"]
    #[inline(always)]
