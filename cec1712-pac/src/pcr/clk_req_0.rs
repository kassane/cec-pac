...
#[doc = "Field `OTP_CLK_REQ` reader - OTP Enable"]
pub type OTP_CLK_REQ_R = crate::BitReader<bool>;
#[doc = "Field `OTP_CLK_REQ` writer - OTP Enable"]
pub type OTP_CLK_REQ_W<'a, const O: u8> = crate::BitWriter<'a, u32, CLK_REQ_0_SPEC, bool, O>;
impl R {
    ...
    #[inline(always)]
    pub fn otp_clk_req(&self) -> OTP_CLK_REQ_R {
        OTP_CLK_REQ_R::new(((self.bits >> 1) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - JTAG STAP Enable"]
    ...
    #[doc = "Bit 1 - OTP Enable"]
    #[inline(always)]
    pub fn otp_clk_req(&mut self) -> OTP_CLK_REQ_W<1> {
        OTP_CLK_REQ_W::new(self)
    }
