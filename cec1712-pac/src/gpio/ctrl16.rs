#[doc = "Register `CTRL16[%s]` reader"]
pub struct R(crate::R<CTRL16_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CTRL16_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CTRL16_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CTRL16_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CTRL16[%s]` writer"]
pub struct W(crate::W<CTRL16_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CTRL16_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CTRL16_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CTRL16_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PU_PD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CTRL16_SPEC, u8, u8, 2, O>;
...
pub type PWR_GATING_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CTRL16_SPEC, u8, u8, 2, O>;
...
pub type INTR_DET_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CTRL16_SPEC, u8, u8, 3, O>;
...
pub type EDGE_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL16_SPEC, bool, O>;
...
pub type OUT_BUFF_TYPE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL16_SPEC, bool, O>;
...
pub type GPIO_DIR_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL16_SPEC, bool, O>;
...
pub type GPIO_OUT_SEL_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL16_SPEC, bool, O>;
...
pub type POL_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL16_SPEC, bool, O>;
...
pub type MUX_CTRL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CTRL16_SPEC, u8, u8, 3, O>;
...
pub type INP_DIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL16_SPEC, bool, O>;
...
pub type ALT_GPIO_DATA_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL16_SPEC, bool, O>;
...
pub type GPIO_INP_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL16_SPEC, bool, O>;
impl R {
...
#[doc = "GPIO Pin Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ctrl16](index.html) module"]
pub struct CTRL16_SPEC;
impl crate::RegisterSpec for CTRL16_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ctrl16::R](R) reader structure"]
impl crate::Readable for CTRL16_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ctrl16::W](W) writer structure"]
impl crate::Writable for CTRL16_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets CTRL16[%s]
to value 0x8040"]
impl crate::Resettable for CTRL16_SPEC {
    #[inline(always)]
