#[doc = "Register `EN_SET24` reader"]
pub struct R(crate::R<EN_SET24_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<EN_SET24_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<EN_SET24_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<EN_SET24_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `EN_SET24` writer"]
pub struct W(crate::W<EN_SET24_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<EN_SET24_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<EN_SET24_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<EN_SET24_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SPIMON0_VLTN_W<'a, const O: u8> = crate::BitWriter<'a, u32, EN_SET24_SPEC, bool, O>;
...
pub type SPIMON0_MTMON_W<'a, const O: u8> = crate::BitWriter<'a, u32, EN_SET24_SPEC, bool, O>;
...
pub type SPIMON0_LTMON_W<'a, const O: u8> = crate::BitWriter<'a, u32, EN_SET24_SPEC, bool, O>;
...
pub type SPIMON1_VLTN_W<'a, const O: u8> = crate::BitWriter<'a, u32, EN_SET24_SPEC, bool, O>;
...
pub type SPIMON1_MTMON_W<'a, const O: u8> = crate::BitWriter<'a, u32, EN_SET24_SPEC, bool, O>;
...
pub type SPIMON1_LTMON_W<'a, const O: u8> = crate::BitWriter<'a, u32, EN_SET24_SPEC, bool, O>;
impl R {
...
#[doc = "GIRQ24 ENABLE SET\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [en_set24](index.html) module"]
pub struct EN_SET24_SPEC;
impl crate::RegisterSpec for EN_SET24_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [en_set24::R](R) reader structure"]
impl crate::Readable for EN_SET24_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [en_set24::W](W) writer structure"]
impl crate::Writable for EN_SET24_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets EN_SET24 to value 0"]
impl crate::Resettable for EN_SET24_SPEC {
    #[inline(always)]
