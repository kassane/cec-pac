...
#[doc = "Field `INFACE_MOD` reader - This field sets the transmission mode. If this field is set for Dual Mode or Quad Mode then either TX_TRANSFER_ENABLE or RX_TRANSFER_ENABLE must be 0. 3=Reserved; 2=Quad Mode; 1=Dual Mode; 0=Single/Duplex Mode."]
pub type INFACE_MOD_R = crate::FieldReader<u8, u8>;
#[doc = "Field `INFACE_MOD` writer - This field sets the transmission mode. If this field is set for Dual Mode or Quad Mode then either TX_TRANSFER_ENABLE or RX_TRANSFER_ENABLE must be 0. 3=Reserved; 2=Quad Mode; 1=Dual Mode; 0=Single/Duplex Mode."]
...
#[doc = "Field `TRANS_LEN` reader - 3=TRANSFER_LENGTH defined in units of 16-byte segments, 2=TRANSFER_LENGTH defined in units of 4-byte segments 1=TRANSFER_LENGTH defined in units of bytes, 0=TRANSFER_LENGTH defined in units of bits"]
pub type TRANS_LEN_R = crate::FieldReader<u8, u8>;
#[doc = "Field `TRANS_LEN` writer - 3=TRANSFER_LENGTH defined in units of 16-byte segments, 2=TRANSFER_LENGTH defined in units of 4-byte segments 1=TRANSFER_LENGTH defined in units of bytes, 0=TRANSFER_LENGTH defined in units of bits"]
pub type TRANS_LEN_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DESCR_SPEC, u8, u8, 2, O>;
...
#[doc = "Field `DESCR_BUF_LAST` reader - Last Descriptor. 1=Last Description Buffer in the chain. 0=This is not the last buffer."]
pub type DESCR_BUF_LAST_R = crate::BitReader<bool>;
#[doc = "Field `DESCR_BUF_LAST` writer - Last Descriptor. 1=Last Description Buffer in the chain. 0=This is not the last buffer."]
...
pub type TX_LEN_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DESCR_SPEC, u16, u16, 15, O>;
impl R {
    ...
    #[doc = "Bit 9 - This selects what action is taken at the end of a transfer. This bit must be set only on the Last Buffer. 1=The transfer is terminated. The Chip Select de-asserts, the SPI interface returns to IDLE and the DMA interface completes the transfer. 0=The transfer is not closed. Chip Select remains asserted and the DMA interface and the SPI interface remain active"]
    #[inline(always)]
    ...
    pub fn trans_len(&self) -> TRANS_LEN_R {
        TRANS_LEN_R::new(((self.bits >> 10) & 3) as u8)
    }
    ...
    #[doc = "Bit 16 - Last Descriptor. 1=Last Description Buffer in the chain. 0=This is not the last buffer."]
    #[inline(always)]
    pub fn descr_buf_last(&self) -> DESCR_BUF_LAST_R {
        DESCR_BUF_LAST_R::new(((self.bits >> 16) & 1) != 0)
    }
    ...
    pub fn tx_len(&self) -> TX_LEN_R {
        TX_LEN_R::new(((self.bits >> 17) & 0x7fff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:1 - This field sets the transmission mode. If this field is set for Dual Mode or Quad Mode then either TX_TRANSFER_ENABLE or RX_TRANSFER_ENABLE must be 0. 3=Reserved; 2=Quad Mode; 1=Dual Mode; 0=Single/Duplex Mode."]
    ...
    #[doc = "Bits 10:11 - 3=TRANSFER_LENGTH defined in units of 16-byte segments, 2=TRANSFER_LENGTH defined in units of 4-byte segments 1=TRANSFER_LENGTH defined in units of bytes, 0=TRANSFER_LENGTH defined in units of bits"]
    #[inline(always)]
    pub fn trans_len(&mut self) -> TRANS_LEN_W<10> {
    ...
    #[doc = "Bit 16 - Last Descriptor. 1=Last Description Buffer in the chain. 0=This is not the last buffer."]
    #[inline(always)]
    pub fn descr_buf_last(&mut self) -> DESCR_BUF_LAST_W<16> {
        DESCR_BUF_LAST_W::new(self)
    }
    #[doc = "Bits 17:31 - The length of the SPI transfer. The count is in bytes or bits, depending on the value of TRANSFER_LENGTH_BITS. A value of 0 means an infinite length transfer."]
    #[inline(always)]
    pub fn tx_len(&mut self) -> TX_LEN_W<17> {
        TX_LEN_W::new(self)
    }
