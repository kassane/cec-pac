#[doc = "Register `LDMA_TXCTRL` reader"]
pub struct R(crate::R<LDMA_TXCTRL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<LDMA_TXCTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<LDMA_TXCTRL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<LDMA_TXCTRL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `LDMA_TXCTRL` writer"]
pub struct W(crate::W<LDMA_TXCTRL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<LDMA_TXCTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<LDMA_TXCTRL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<LDMA_TXCTRL_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `CH_EN` reader - This enables the Local TX DMA Channel."]
pub type CH_EN_R = crate::BitReader<bool>;
#[doc = "Field `CH_EN` writer - This enables the Local TX DMA Channel."]
pub type CH_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, LDMA_TXCTRL_SPEC, bool, O>;
...
pub type RSTRT_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, LDMA_TXCTRL_SPEC, bool, O>;
...
pub type BUF_ADDR_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, LDMA_TXCTRL_SPEC, bool, O>;
...
pub type OVRD_LEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, LDMA_TXCTRL_SPEC, bool, O>;
...
pub type ACS_SZ_W<'a, const O: u8> = crate::FieldWriter<'a, u32, LDMA_TXCTRL_SPEC, u8, u8, 2, O>;
...
pub type INC_ADDR_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, LDMA_TXCTRL_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0 - This enables the Local TX DMA Channel."]
    #[inline(always)]
...
#[doc = "QMSPI TX Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ldma_txctrl](index.html) module"]
pub struct LDMA_TXCTRL_SPEC;
impl crate::RegisterSpec for LDMA_TXCTRL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ldma_txctrl::R](R) reader structure"]
impl crate::Readable for LDMA_TXCTRL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ldma_txctrl::W](W) writer structure"]
impl crate::Writable for LDMA_TXCTRL_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets LDMA_TXCTRL to value 0"]
impl crate::Resettable for LDMA_TXCTRL_SPEC {
    #[inline(always)]
