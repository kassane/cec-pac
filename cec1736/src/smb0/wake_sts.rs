...
#[doc = "Field `START_BIT_DET` reader - This bit is set to '1' when a START bit is detected while the controller is enabled. This bit is cleared to '0' when written with a '1'. Writes of '0' have no effect. (R/WC)"]
pub type START_BIT_DET_R = crate::BitReader<bool>;
#[doc = "Field `START_BIT_DET` writer - This bit is set to '1' when a START bit is detected while the controller is enabled. This bit is cleared to '0' when written with a '1'. Writes of '0' have no effect. (R/WC)"]
pub type START_BIT_DET_W<'a, const O: u8> = crate::BitWriter<'a, u32, WAKE_STS_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0 - This bit is set to '1' when a START bit is detected while the controller is enabled. This bit is cleared to '0' when written with a '1'. Writes of '0' have no effect. (R/WC)"]
    #[inline(always)]
