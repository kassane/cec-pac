...
#[doc = "Field `ADDR_INTR` reader - This is the Promiscuous Address Status interrupt and is set on the 8th clock of the I2C Address. This bit will hold the Clock line low till this register bit is cleared. This is Write 1 to clear. R/W1C."]
pub type ADDR_INTR_R = crate::BitReader<bool>;
#[doc = "Field `ADDR_INTR` writer - This is the Promiscuous Address Status interrupt and is set on the 8th clock of the I2C Address. This bit will hold the Clock line low till this register bit is cleared. This is Write 1 to clear. R/W1C."]
pub type ADDR_INTR_W<'a, const O: u8> = crate::BitWriter<'a, u8, PRM_STS_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0 - This is the Promiscuous Address Status interrupt and is set on the 8th clock of the I2C Address. This bit will hold the Clock line low till this register bit is cleared. This is Write 1 to clear. R/W1C."]
    #[inline(always)]
