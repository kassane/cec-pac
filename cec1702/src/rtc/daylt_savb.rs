#[doc = "Register `DAYLT_SAVB` reader"]
pub struct R(crate::R<DAYLT_SAVB_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DAYLT_SAVB_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DAYLT_SAVB_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DAYLT_SAVB_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DAYLT_SAVB` writer"]
pub struct W(crate::W<DAYLT_SAVB_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DAYLT_SAVB_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DAYLT_SAVB_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DAYLT_SAVB_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DST_MON_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DAYLT_SAVB_SPEC, u8, u8, 8, O>;
...
pub type DST_DAY_OF_WK_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DAYLT_SAVB_SPEC, u8, u8, 3, O>;
...
pub type DST_WK_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DAYLT_SAVB_SPEC, u8, u8, 3, O>;
...
of the Hours register. The written value will be interpreted according\n to the 24/12 Hour mode and DM mode settings at the time of writing."]
pub type DST_HR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DAYLT_SAVB_SPEC, u8, u8, 7, O>;
...
of the Hours Register if 12-Hour mode is selected in Register B at the time\n of writing."]
pub type DST_AM_PM_W<'a, const O: u8> = crate::BitWriter<'a, u32, DAYLT_SAVB_SPEC, bool, O>;
impl R {
...
#[doc = "Daylight Savings Backward Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [daylt_savb](index.html) module"]
pub struct DAYLT_SAVB_SPEC;
impl crate::RegisterSpec for DAYLT_SAVB_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [daylt_savb::R](R) reader structure"]
impl crate::Readable for DAYLT_SAVB_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [daylt_savb::W](W) writer structure"]
impl crate::Writable for DAYLT_SAVB_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets DAYLT_SAVB to value 0"]
impl crate::Resettable for DAYLT_SAVB_SPEC {
    #[inline(always)]
