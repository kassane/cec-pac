...
#[doc = "Field `OUTOF_LIM_STS` reader - OUTOF_LIM_STS 1=Tach is outside of limits, 0=Tach is within limits (R/WC)"]
pub type OUTOF_LIM_STS_R = crate::BitReader<bool>;
#[doc = "Field `OUTOF_LIM_STS` writer - OUTOF_LIM_STS 1=Tach is outside of limits, 0=Tach is within limits (R/WC)"]
pub type OUTOF_LIM_STS_W<'a, const O: u8> = crate::BitWriter<'a, u32, STS_SPEC, bool, O>;
#[doc = "Field `PIN_STS` reader - PIN_STS 1= Tach Input is high, 0= Tach Input is low"]
pub type PIN_STS_R = crate::BitReader<bool>;
#[doc = "Field `PIN_STS` writer - PIN_STS 1= Tach Input is high, 0= Tach Input is low"]
pub type PIN_STS_W<'a, const O: u8> = crate::BitWriter<'a, u32, STS_SPEC, bool, O>;
#[doc = "Field `TOG_STS` reader - TOG_STS 1=Tach Input changed state (this bit is set on a low-to-high or high-tolow transition), 0=Tach stable (R/WC)"]
pub type TOG_STS_R = crate::BitReader<bool>;
#[doc = "Field `TOG_STS` writer - TOG_STS 1=Tach Input changed state (this bit is set on a low-to-high or high-tolow transition), 0=Tach stable (R/WC)"]
pub type TOG_STS_W<'a, const O: u8> = crate::BitWriter<'a, u32, STS_SPEC, bool, O>;
#[doc = "Field `CNT_RDY_STS` reader - CNT_RDY_STS 1=Reading ready, 0=Reading not ready"]
pub type CNT_RDY_STS_R = crate::BitReader<bool>;
#[doc = "Field `CNT_RDY_STS` writer - CNT_RDY_STS 1=Reading ready, 0=Reading not ready"]
pub type CNT_RDY_STS_W<'a, const O: u8> = crate::BitWriter<'a, u32, STS_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0 - OUTOF_LIM_STS 1=Tach is outside of limits, 0=Tach is within limits (R/WC)"]
    #[inline(always)]
    pub fn outof_lim_sts(&self) -> OUTOF_LIM_STS_R {
        OUTOF_LIM_STS_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - PIN_STS 1= Tach Input is high, 0= Tach Input is low"]
    #[inline(always)]
    pub fn pin_sts(&self) -> PIN_STS_R {
        PIN_STS_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - TOG_STS 1=Tach Input changed state (this bit is set on a low-to-high or high-tolow transition), 0=Tach stable (R/WC)"]
    #[inline(always)]
    pub fn tog_sts(&self) -> TOG_STS_R {
        TOG_STS_R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - CNT_RDY_STS 1=Reading ready, 0=Reading not ready"]
    #[inline(always)]
