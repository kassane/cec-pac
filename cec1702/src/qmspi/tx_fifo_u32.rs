#[doc = "Register `TX_FIFO_u32` reader"]
pub struct R(crate::R<TX_FIFO_U32_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TX_FIFO_U32_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TX_FIFO_U32_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TX_FIFO_U32_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TX_FIFO_u32` writer"]
pub struct W(crate::W<TX_FIFO_U32_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TX_FIFO_U32_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TX_FIFO_U32_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TX_FIFO_U32_SPEC>) -> Self {
        W(writer)
    }
}
...
and Word write is on \\[15:0\\]).\n An overflow condition, TRANSMIT_BUFFER_ERROR, if a write to a full FIFO occurs.\n Write accesses to this register increment the TRANSMIT_BUFFER_COUNT field."]
pub type TX_BUF_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TX_FIFO_U32_SPEC, u32, u32, 32, O>;
impl R {
...
#[doc = "QMSPI Transmit Buffer Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [tx_fifo_u32](index.html) module"]
pub struct TX_FIFO_U32_SPEC;
impl crate::RegisterSpec for TX_FIFO_U32_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [tx_fifo_u32::R](R) reader structure"]
impl crate::Readable for TX_FIFO_U32_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [tx_fifo_u32::W](W) writer structure"]
impl crate::Writable for TX_FIFO_U32_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets TX_FIFO_u32 to value 0"]
impl crate::Resettable for TX_FIFO_U32_SPEC {
    #[inline(always)]
