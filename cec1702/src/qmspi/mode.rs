...
#[doc = "Field `CLK_DIV` reader - The SPI clock divide in number of system clocks. A value of 1 divides the master clock by 1, a value of 255 divides the master clock by 255.\n A value of 0 divides the master clock by 256."]
pub type CLK_DIV_R = crate::FieldReader<u16, u16>;
#[doc = "Field `CLK_DIV` writer - The SPI clock divide in number of system clocks. A value of 1 divides the master clock by 1, a value of 255 divides the master clock by 255.\n A value of 0 divides the master clock by 256."]
...
impl R {
    ...
    #[doc = "Bits 16:24 - The SPI clock divide in number of system clocks. A value of 1 divides the master clock by 1, a value of 255 divides the master clock by 255.\n A value of 0 divides the master clock by 256."]
    #[inline(always)]
...
#[doc = "`reset()` method sets MODE to value 0x0f"]
