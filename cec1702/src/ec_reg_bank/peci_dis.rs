...
#[doc = "Field `PECI_DISABLE` reader - When this bit is asserted 1, it disables the PECI pads to reduce leakage."]
pub type PECI_DISABLE_R = crate::BitReader<bool>;
#[doc = "Field `PECI_DISABLE` writer - When this bit is asserted 1, it disables the PECI pads to reduce leakage."]
pub type PECI_DISABLE_W<'a, const O: u8> = crate::BitWriter<'a, u32, PECI_DIS_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0 - When this bit is asserted 1, it disables the PECI pads to reduce leakage."]
    #[inline(always)]
    pub fn peci_disable(&self) -> PECI_DISABLE_R {
        PECI_DISABLE_R::new((self.bits & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - When this bit is asserted 1, it disables the PECI pads to reduce leakage."]
    #[inline(always)]
    pub fn peci_disable(&mut self) -> PECI_DISABLE_W<0> {
        PECI_DISABLE_W::new(self)
    }
