...
#[doc = "Field `SYMMETRY` reader - SYMMETRY 1=The rising and falling ramp times are in Asymmetric mode.\n 0=The rising and falling ramp times are in Symmetric mode."]
pub type SYMMETRY_R = crate::BitReader<bool>;
#[doc = "Field `SYMMETRY` writer - SYMMETRY 1=The rising and falling ramp times are in Asymmetric mode.\n 0=The rising and falling ramp times are in Symmetric mode."]
pub type SYMMETRY_W<'a, const O: u8> = crate::BitWriter<'a, u32, CFG_SPEC, bool, O>;
impl R {
    #[doc = "Bits 0:1 - CTRL 3=PWM is always on\n 2=LED blinking (standard PWM)\n 1=LED breathing configuration\n 0=PWM is always off. All internal registers and counters are reset to 0. Clocks are gated"]
    #[inline(always)]
    ...
    #[doc = "Bit 3 - SYNCH When this bit is '1', all counters for all LEDs are reset to their initial values.\n When this bit is '0' in the LED Configuration Register for all LEDs, then all counters for LEDs that are configured to blink or breathe will increment or decrement, as required."]
    #[inline(always)]
    pub fn synch(&self) -> SYNCH_R {
        SYNCH_R::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bits 4:5 - PWM_SIZE This bit controls the behavior of PWM:\n 3=Reserved\n 2=PWM is configured as a 6-bit PWM\n 1=PWM is configured as a 7-bit PWM\n 0=PWM is configured as an 8-bit PWM"]
    #[inline(always)]
    pub fn pwm_size(&self) -> PWM_SIZE_R {
        PWM_SIZE_R::new(((self.bits >> 4) & 3) as u8)
    }
    #[doc = "Bit 6 - EN_UPDATE This bit is set to 1 when written with a '1'. Writes of '0' have no effect.\n Hardware clears this bit to 0 when the breathing configuration registers are updated at the end of a PWM period. The current state of the bit is readable any time."]
    #[inline(always)]
    pub fn en_update(&self) -> EN_UPDATE_R {
        EN_UPDATE_R::new(((self.bits >> 6) & 1) != 0)
    }
    #[doc = "Bit 7 - RST Writes of '1' to this bit resets the PWM registers to their default values. This bit is self clearing.\n Writes of '0' to this bit have no effect."]
    #[inline(always)]
    ...
    #[doc = "Bit 16 - SYMMETRY 1=The rising and falling ramp times are in Asymmetric mode.\n 0=The rising and falling ramp times are in Symmetric mode."]
    #[inline(always)]
