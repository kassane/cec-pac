#[doc = "Register `SCMD_u32` reader"]
pub struct R(crate::R<SCMD_U32_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SCMD_U32_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SCMD_U32_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SCMD_U32_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SCMD_u32` writer"]
pub struct W(crate::W<SCMD_U32_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SCMD_U32_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SCMD_U32_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SCMD_U32_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SRUN_W<'a, const O: u8> = crate::BitWriter<'a, u32, SCMD_U32_SPEC, bool, O>;
...
pub type SPROCEED_W<'a, const O: u8> = crate::BitWriter<'a, u32, SCMD_U32_SPEC, bool, O>;
...
pub type PEC_W<'a, const O: u8> = crate::BitWriter<'a, u32, SCMD_U32_SPEC, bool, O>;
...
pub type WR_CNT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SCMD_U32_SPEC, u8, u8, 8, O>;
...
pub type RD_CNT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SCMD_U32_SPEC, u8, u8, 8, O>;
impl R {
...
#[doc = "SMBus Slave Command Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [scmd_u32](index.html) module"]
pub struct SCMD_U32_SPEC;
impl crate::RegisterSpec for SCMD_U32_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [scmd_u32::R](R) reader structure"]
impl crate::Readable for SCMD_U32_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [scmd_u32::W](W) writer structure"]
impl crate::Writable for SCMD_U32_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets SCMD_u32 to value 0"]
impl crate::Resettable for SCMD_U32_SPEC {
    #[inline(always)]
