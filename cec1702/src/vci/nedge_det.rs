...
pub type VCI_IN_W<'a, const O: u8> = crate::FieldWriter<'a, u32, NEDGE_DET_SPEC, u8, u8, 7, O>;
impl R {
    #[doc = "Bits 0:6 - These bits record a high to low transition on the VCI_IN# pins. A 1 indicates a transition occurred. For each bit in the field:\n 1=Negative Edge Detected; 0=No edge detected."]
    #[inline(always)]
