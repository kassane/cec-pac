...
#[doc = "Field `BUS_ERR` reader - This is an interrupt source register. This flags when there is an Error detected over the internal 32-bit Bus.\n 1: Error detected. (R/WC)"]
pub type BUS_ERR_R = crate::BitReader<bool>;
#[doc = "Field `BUS_ERR` writer - This is an interrupt source register. This flags when there is an Error detected over the internal 32-bit Bus.\n 1: Error detected. (R/WC)"]
