...
#[doc = "Field `UART_0_CLK_REQ` reader - UART 0 Clock Reuqired"]
pub type UART_0_CLK_REQ_R = crate::BitReader<bool>;
#[doc = "Field `UART_0_CLK_REQ` writer - UART 0 Clock Reuqired"]
pub type UART_0_CLK_REQ_W<'a, const O: u8> = crate::BitWriter<'a, u32, CLK_REQ_2_SPEC, bool, O>;
#[doc = "Field `UART_1_CLK_REQ` reader - UART 1 Clock Reuqired"]
pub type UART_1_CLK_REQ_R = crate::BitReader<bool>;
#[doc = "Field `UART_1_CLK_REQ` writer - UART 1 Clock Reuqired"]
pub type UART_1_CLK_REQ_W<'a, const O: u8> = crate::BitWriter<'a, u32, CLK_REQ_2_SPEC, bool, O>;
#[doc = "Field `GLBL_CFG_CLK_REQ` reader - GLBL_CFG Clock Reuqired"]
pub type GLBL_CFG_CLK_REQ_R = crate::BitReader<bool>;
#[doc = "Field `GLBL_CFG_CLK_REQ` writer - GLBL_CFG Clock Reuqired"]
pub type GLBL_CFG_CLK_REQ_W<'a, const O: u8> = crate::BitWriter<'a, u32, CLK_REQ_2_SPEC, bool, O>;
#[doc = "Field `RTC_CLK_REQ` reader - RTC Clock Reuqired"]
pub type RTC_CLK_REQ_R = crate::BitReader<bool>;
#[doc = "Field `RTC_CLK_REQ` writer - RTC Clock Reuqired"]
pub type RTC_CLK_REQ_W<'a, const O: u8> = crate::BitWriter<'a, u32, CLK_REQ_2_SPEC, bool, O>;
impl R {
    #[doc = "Bit 1 - UART 0 Clock Reuqired"]
    #[inline(always)]
    pub fn uart_0_clk_req(&self) -> UART_0_CLK_REQ_R {
        UART_0_CLK_REQ_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - UART 1 Clock Reuqired"]
    #[inline(always)]
    pub fn uart_1_clk_req(&self) -> UART_1_CLK_REQ_R {
        UART_1_CLK_REQ_R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 12 - GLBL_CFG Clock Reuqired"]
    #[inline(always)]
    pub fn glbl_cfg_clk_req(&self) -> GLBL_CFG_CLK_REQ_R {
        GLBL_CFG_CLK_REQ_R::new(((self.bits >> 12) & 1) != 0)
    }
    #[doc = "Bit 18 - RTC Clock Reuqired"]
    #[inline(always)]
...
impl W {
    #[doc = "Bit 1 - UART 0 Clock Reuqired"]
    #[inline(always)]
    pub fn uart_0_clk_req(&mut self) -> UART_0_CLK_REQ_W<1> {
        UART_0_CLK_REQ_W::new(self)
    }
    #[doc = "Bit 2 - UART 1 Clock Reuqired"]
    #[inline(always)]
    pub fn uart_1_clk_req(&mut self) -> UART_1_CLK_REQ_W<2> {
        UART_1_CLK_REQ_W::new(self)
    }
    #[doc = "Bit 12 - GLBL_CFG Clock Reuqired"]
    #[inline(always)]
