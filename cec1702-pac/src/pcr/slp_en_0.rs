...
#[doc = "Field `JTAG_STAP_SLP_EN` reader - JTAG STAP Enable"]
pub type JTAG_STAP_SLP_EN_R = crate::BitReader<bool>;
#[doc = "Field `JTAG_STAP_SLP_EN` writer - JTAG STAP Enable"]
pub type JTAG_STAP_SLP_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, SLP_EN_0_SPEC, bool, O>;
#[doc = "Field `OTP_SLP_EN` reader - eFuse Enable"]
pub type OTP_SLP_EN_R = crate::BitReader<bool>;
#[doc = "Field `OTP_SLP_EN` writer - eFuse Enable"]
pub type OTP_SLP_EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, SLP_EN_0_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0 - JTAG STAP Enable"]
    #[inline(always)]
    pub fn jtag_stap_slp_en(&self) -> JTAG_STAP_SLP_EN_R {
        JTAG_STAP_SLP_EN_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - eFuse Enable"]
    #[inline(always)]
...
impl W {
    #[doc = "Bit 0 - JTAG STAP Enable"]
    #[inline(always)]
    pub fn jtag_stap_slp_en(&mut self) -> JTAG_STAP_SLP_EN_W<0> {
        JTAG_STAP_SLP_EN_W::new(self)
    }
    #[doc = "Bit 1 - eFuse Enable"]
    #[inline(always)]
