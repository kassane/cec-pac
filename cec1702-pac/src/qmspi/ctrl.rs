...
#[doc = "Field `TRANS_LEN` reader - The length of the SPI transfer. The count is in bytes or bits, depending on the value of TRANS_LEN_BITS.\n A value of 0 means an infinite length transfer."]
pub type TRANS_LEN_R = crate::FieldReader<u16, u16>;
#[doc = "Field `TRANS_LEN` writer - The length of the SPI transfer. The count is in bytes or bits, depending on the value of TRANS_LEN_BITS.\n A value of 0 means an infinite length transfer."]
...
impl R {
    ...
    #[doc = "Bits 17:31 - The length of the SPI transfer. The count is in bytes or bits, depending on the value of TRANS_LEN_BITS.\n A value of 0 means an infinite length transfer."]
    #[inline(always)]
