#[doc = "Register `RX_FIFO_u16[%s]` reader"]
pub struct R(crate::R<RX_FIFO_U16_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RX_FIFO_U16_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RX_FIFO_U16_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RX_FIFO_U16_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RX_FIFO_u16[%s]` writer"]
pub struct W(crate::W<RX_FIFO_U16_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RX_FIFO_U16_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RX_FIFO_U16_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RX_FIFO_U16_SPEC>) -> Self {
        W(writer)
    }
}
...
and a Word read will have data on bits \\[15:0\\].\n It is possible to request more data than the FIFO has (underflow condition), but this will cause an error (Rx Buffer Error).\n Read accesses to this register decrement the RECEIVE_BUFFER_COUNT field."]
pub type RX_BUF_W<'a, const O: u8> = crate::FieldWriter<'a, u16, RX_FIFO_U16_SPEC, u32, u32, 32, O>;
impl R {
...
#[doc = "QMSPI Receive Buffer Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rx_fifo_u16](index.html) module"]
pub struct RX_FIFO_U16_SPEC;
impl crate::RegisterSpec for RX_FIFO_U16_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [rx_fifo_u16::R](R) reader structure"]
impl crate::Readable for RX_FIFO_U16_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [rx_fifo_u16::W](W) writer structure"]
impl crate::Writable for RX_FIFO_U16_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets RX_FIFO_u16[%s]
to value 0"]
impl crate::Resettable for RX_FIFO_U16_SPEC {
    #[inline(always)]
