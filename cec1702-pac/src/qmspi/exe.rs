...
#[doc = "Field `CLR_DAT_BUFF` reader - Writing a 1 to this bit will clear out the Transmit and Receive FIFOs.\n Any data stored in the FIFOs is discarded and all count fields are reset.\n Writing a 0 to this bit has no effect. This bit is self clearing."]
pub type CLR_DAT_BUFF_R = crate::BitReader<bool>;
#[doc = "Field `CLR_DAT_BUFF` writer - Writing a 1 to this bit will clear out the Transmit and Receive FIFOs.\n Any data stored in the FIFOs is discarded and all count fields are reset.\n Writing a 0 to this bit has no effect. This bit is self clearing."]
...
impl R {
    ...
    #[doc = "Bit 2 - Writing a 1 to this bit will clear out the Transmit and Receive FIFOs.\n Any data stored in the FIFOs is discarded and all count fields are reset.\n Writing a 0 to this bit has no effect. This bit is self clearing."]
    #[inline(always)]
...
#[doc = "`reset()` method sets EXE to value 0x01"]
