...
#[doc = "Field `INFACE_MOD` reader - This field sets the transmission mode. If this field is set for Dual Mode or Quad Mode then either TX_TRANSFER_ENABLE \n or RX_TRANSFER_ENABLE must be 0.3=Reserved; 2=Quad Mode; 1=Dual Mode; 0=Single/Duplex Mode."]
pub type INFACE_MOD_R = crate::FieldReader<u8, u8>;
#[doc = "Field `INFACE_MOD` writer - This field sets the transmission mode. If this field is set for Dual Mode or Quad Mode then either TX_TRANSFER_ENABLE \n or RX_TRANSFER_ENABLE must be 0.3=Reserved; 2=Quad Mode; 1=Dual Mode; 0=Single/Duplex Mode."]
...
#[doc = "Field `DESCR_BUF_LAST` reader - If this bit is 1 then this is the last Description Buffer in the chain. When the transfer described by this buffer \n completes the TRANSFER_ COMPLETE status will be set to 1. If this bit is 0, then this is not the last buffer in use. When the transfer completes the next buffer \n will be activated, and no additional status will be asserted."]
pub type DESCR_BUF_LAST_R = crate::BitReader<bool>;
#[doc = "Field `DESCR_BUF_LAST` writer - If this bit is 1 then this is the last Description Buffer in the chain. When the transfer described by this buffer \n completes the TRANSFER_ COMPLETE status will be set to 1. If this bit is 0, then this is not the last buffer in use. When the transfer completes the next buffer \n will be activated, and no additional status will be asserted."]
pub type DESCR_BUF_LAST_W<'a, const O: u8> = crate::BitWriter<'a, u32, DESCR_SPEC, bool, O>;
#[doc = "Field `DESCR_BUF_NXT_PTR` reader - This defines the next buffer to be used if Description Buffers are enabled and this is not the last buffer. \n This can point to the current buffer, creating an infinite loop."]
pub type DESCR_BUF_NXT_PTR_R = crate::FieldReader<u8, u8>;
#[doc = "Field `DESCR_BUF_NXT_PTR` writer - This defines the next buffer to be used if Description Buffers are enabled and this is not the last buffer. \n This can point to the current buffer, creating an infinite loop."]
pub type DESCR_BUF_NXT_PTR_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DESCR_SPEC, u8, u8, 4, O>;
#[doc = "Field `TX_LEN` reader - The length of the SPI transfer. The count is in bytes or bits, depending on the value of TX_LEN_BITS. \n A value of 0 means an infinite length transfer."]
pub type TX_LEN_R = crate::FieldReader<u16, u16>;
#[doc = "Field `TX_LEN` writer - The length of the SPI transfer. The count is in bytes or bits, depending on the value of TX_LEN_BITS. \n A value of 0 means an infinite length transfer."]
pub type TX_LEN_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DESCR_SPEC, u16, u16, 16, O>;
impl R {
    #[doc = "Bits 0:1 - This field sets the transmission mode. If this field is set for Dual Mode or Quad Mode then either TX_TRANSFER_ENABLE \n or RX_TRANSFER_ENABLE must be 0.3=Reserved; 2=Quad Mode; 1=Dual Mode; 0=Single/Duplex Mode."]
    #[inline(always)]
    ...
    #[doc = "Bits 7:8 - This bit enables DMA support for Receive Transfer. If enabled, DMA will be requested to empty the FIFO \n until either the interface reaches TRANSFER_LENGTH or the DMA sends a termination request.\n The size defined here must match DMA programmed access size.\n 1=DMA is enabled.and set to 1 Byte\n 2=DMA is enabled and set to 2 Bytes\n 3=DMA is enabled and set to 4 Bytes\n 0=DMA is disabled. All data in the Receive Buffer must be emptied by firmware."]
    #[inline(always)]
    ...
    #[doc = "Bit 11 - If this bit is 1 then this is the last Description Buffer in the chain. When the transfer described by this buffer \n completes the TRANSFER_ COMPLETE status will be set to 1. If this bit is 0, then this is not the last buffer in use. When the transfer completes the next buffer \n will be activated, and no additional status will be asserted."]
    #[inline(always)]
    pub fn descr_buf_last(&self) -> DESCR_BUF_LAST_R {
        DESCR_BUF_LAST_R::new(((self.bits >> 11) & 1) != 0)
    }
    #[doc = "Bits 12:15 - This defines the next buffer to be used if Description Buffers are enabled and this is not the last buffer. \n This can point to the current buffer, creating an infinite loop."]
    #[inline(always)]
    pub fn descr_buf_nxt_ptr(&self) -> DESCR_BUF_NXT_PTR_R {
        DESCR_BUF_NXT_PTR_R::new(((self.bits >> 12) & 0x0f) as u8)
    }
    #[doc = "Bits 16:31 - The length of the SPI transfer. The count is in bytes or bits, depending on the value of TX_LEN_BITS. \n A value of 0 means an infinite length transfer."]
    #[inline(always)]
