...
#[doc = "Field `M2S_2H_BACKUP` reader - The Boot ROM firmware will copy this field into the SRC3 to SRC0 bits of the Master-to-Slave Virtual Wire Register\n that corresponds to Virtual Wire Index 2h on a RESET_SYS. If software always saves the state of the Index 2h SRC bits on the falling\n edge of the SUSWARN# virtual wire, the state of the four SRC bits will be synchronized to the state of the four bits in the core logic."]
pub type M2S_2H_BACKUP_R = crate::FieldReader<u8, u8>;
#[doc = "Field `M2S_2H_BACKUP` writer - The Boot ROM firmware will copy this field into the SRC3 to SRC0 bits of the Master-to-Slave Virtual Wire Register\n that corresponds to Virtual Wire Index 2h on a RESET_SYS. If software always saves the state of the Index 2h SRC bits on the falling\n edge of the SUSWARN# virtual wire, the state of the four SRC bits will be synchronized to the state of the four bits in the core logic."]
pub type M2S_2H_BACKUP_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, VWR_BCKP_SPEC, u8, u8, 4, O>;
#[doc = "Field `M2S_42H_BACKUP` reader - The Boot ROM firmware will copy this field into the SRC3 to SRC0 bits of the Master-to-Slave Virtual Wire Register\n that corresponds to Virtual Wire Index 42h on a RESET_SYS. If software always saves the state of the Index 2h SRC bits on the falling\n edge of the SUSWARN# virtual wire, the state of the four SRC bits will be synchronized to the state of the four bits in the core logic."]
pub type M2S_42H_BACKUP_R = crate::FieldReader<u8, u8>;
#[doc = "Field `M2S_42H_BACKUP` writer - The Boot ROM firmware will copy this field into the SRC3 to SRC0 bits of the Master-to-Slave Virtual Wire Register\n that corresponds to Virtual Wire Index 42h on a RESET_SYS. If software always saves the state of the Index 2h SRC bits on the falling\n edge of the SUSWARN# virtual wire, the state of the four SRC bits will be synchronized to the state of the four bits in the core logic."]
pub type M2S_42H_BACKUP_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, VWR_BCKP_SPEC, u8, u8, 4, O>;
impl R {
    ...
    #[inline(always)]
    pub fn m2s_2h_backup(&self) -> M2S_2H_BACKUP_R {
        M2S_2H_BACKUP_R::new((self.bits & 0x0f) as u8)
    }
    ...
    #[inline(always)]
    pub fn m2s_42h_backup(&self) -> M2S_42H_BACKUP_R {
        M2S_42H_BACKUP_R::new(((self.bits >> 4) & 0x0f) as u8)
    }
}
impl W {
    #[doc = "Bits 0:3 - The Boot ROM firmware will copy this field into the SRC3 to SRC0 bits of the Master-to-Slave Virtual Wire Register\n that corresponds to Virtual Wire Index 2h on a RESET_SYS. If software always saves the state of the Index 2h SRC bits on the falling\n edge of the SUSWARN# virtual wire, the state of the four SRC bits will be synchronized to the state of the four bits in the core logic."]
    #[inline(always)]
    pub fn m2s_2h_backup(&mut self) -> M2S_2H_BACKUP_W<0> {
        M2S_2H_BACKUP_W::new(self)
    }
    #[doc = "Bits 4:7 - The Boot ROM firmware will copy this field into the SRC3 to SRC0 bits of the Master-to-Slave Virtual Wire Register\n that corresponds to Virtual Wire Index 42h on a RESET_SYS. If software always saves the state of the Index 2h SRC bits on the falling\n edge of the SUSWARN# virtual wire, the state of the four SRC bits will be synchronized to the state of the four bits in the core logic."]
    #[inline(always)]
    pub fn m2s_42h_backup(&mut self) -> M2S_42H_BACKUP_W<4> {
        M2S_42H_BACKUP_W::new(self)
    }
