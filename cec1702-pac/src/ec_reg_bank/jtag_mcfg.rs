...
#[doc = "Field `JTM_CLK` reader - This field determines the JTAG Master clock rate, derived from the 48MHz master clock.\n 7=375KHz; 6=750KHz; 5=1.5Mhz; 4=3Mhz; 3=6Mhz; 2=12Mhz; 1=24MHz; 0=Reserved."]
pub type JTM_CLK_R = crate::FieldReader<u8, JTM_CLKSELECT_A>;
#[doc = "This field determines the JTAG Master clock rate, derived from the 48MHz master clock.\n 7=375KHz; 6=750KHz; 5=1.5Mhz; 4=3Mhz; 3=6Mhz; 2=12Mhz; 1=24MHz; 0=Reserved.\n\nValue on reset: 3"]
...
#[doc = "Field `JTM_CLK` writer - This field determines the JTAG Master clock rate, derived from the 48MHz master clock.\n 7=375KHz; 6=750KHz; 5=1.5Mhz; 4=3Mhz; 3=6Mhz; 2=12Mhz; 1=24MHz; 0=Reserved."]
...
impl R {
    #[doc = "Bits 0:2 - This field determines the JTAG Master clock rate, derived from the 48MHz master clock.\n 7=375KHz; 6=750KHz; 5=1.5Mhz; 4=3Mhz; 3=6Mhz; 2=12Mhz; 1=24MHz; 0=Reserved."]
    #[inline(always)]
...
#[doc = "`reset()` method sets JTAG_MCFG to value 0x03"]
