#[doc = "Register `MCMD_u16[%s]` reader"]
pub struct R(crate::R<MCMD_U16_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MCMD_U16_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MCMD_U16_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MCMD_U16_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `MCMD_u16[%s]` writer"]
pub struct W(crate::W<MCMD_U16_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MCMD_U16_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MCMD_U16_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MCMD_U16_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type MRUN_W<'a, const O: u8> = crate::BitWriter<'a, u16, MCMD_U16_SPEC, bool, O>;
...
pub type MPROCEED_W<'a, const O: u8> = crate::BitWriter<'a, u16, MCMD_U16_SPEC, bool, O>;
...
pub type START0_W<'a, const O: u8> = crate::BitWriter<'a, u16, MCMD_U16_SPEC, bool, O>;
...
pub type STARTN_W<'a, const O: u8> = crate::BitWriter<'a, u16, MCMD_U16_SPEC, bool, O>;
...
pub type STOP_W<'a, const O: u8> = crate::BitWriter<'a, u16, MCMD_U16_SPEC, bool, O>;
...
pub type PEC_TERM_W<'a, const O: u8> = crate::BitWriter<'a, u16, MCMD_U16_SPEC, bool, O>;
...
is 1. After ReadCount\\[7:0\\]
is updated, this bit is cleared to 0."]
pub type READM_W<'a, const O: u8> = crate::BitWriter<'a, u16, MCMD_U16_SPEC, bool, O>;
#[doc = "Field `READ_PEC` reader - If this bit is 0, reading from the SMBus stops when ReadCount reaches 0. If this bit is 1, reading continues when ReadCount is 0 for one more byte."]
pub type READ_PEC_R = crate::BitReader<bool>;
#[doc = "Field `READ_PEC` writer - If this bit is 0, reading from the SMBus stops when ReadCount reaches 0. If this bit is 1, reading continues when ReadCount is 0 for one more byte."]
pub type READ_PEC_W<'a, const O: u8> = crate::BitWriter<'a, u16, MCMD_U16_SPEC, bool, O>;
...
pub type WR_CNT_W<'a, const O: u8> = crate::FieldWriter<'a, u16, MCMD_U16_SPEC, u8, u8, 8, O>;
...
pub type RD_CNT_W<'a, const O: u8> = crate::FieldWriter<'a, u16, MCMD_U16_SPEC, u8, u8, 8, O>;
impl R {
...
is updated, this bit is cleared to 0."]
    ...
    #[inline(always)]
    pub fn read_pec(&self) -> READ_PEC_R {
        READ_PEC_R::new(((self.bits >> 13) & 1) != 0)
    }
...
is updated, this bit is cleared to 0."]
    ...
    #[doc = "Bit 13 - If this bit is 0, reading from the SMBus stops when ReadCount reaches 0. If this bit is 1, reading continues when ReadCount is 0 for one more byte."]
    #[inline(always)]
    pub fn read_pec(&mut self) -> READ_PEC_W<13> {
        READ_PEC_W::new(self)
    }
    #[doc = "Bits 16:23 - This field is a count of the number of bytes to transmit to the SMBus from the SMBus Master Transmit Buffer Register It is decremented by 1 for each byte written to the SMBus from the SMBus Master Transmit Buffer Register."]
    #[inline(always)]
...
#[doc = "SMBus Master Command Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [mcmd_u16](index.html) module"]
pub struct MCMD_U16_SPEC;
impl crate::RegisterSpec for MCMD_U16_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [mcmd_u16::R](R) reader structure"]
impl crate::Readable for MCMD_U16_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [mcmd_u16::W](W) writer structure"]
impl crate::Writable for MCMD_U16_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets MCMD_u16[%s]
to value 0"]
impl crate::Resettable for MCMD_U16_SPEC {
    #[inline(always)]
