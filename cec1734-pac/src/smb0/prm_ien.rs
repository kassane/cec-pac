...
#[doc = "Field `ADDR` reader - This is the Promiscuous interrupt enable register. 1= Interrupt Enable. 0= Interrupt Disabled."]
pub type ADDR_R = crate::BitReader<bool>;
#[doc = "Field `ADDR` writer - This is the Promiscuous interrupt enable register. 1= Interrupt Enable. 0= Interrupt Disabled."]
pub type ADDR_W<'a, const O: u8> = crate::BitWriter<'a, u8, PRM_IEN_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0 - This is the Promiscuous interrupt enable register. 1= Interrupt Enable. 0= Interrupt Disabled."]
    #[inline(always)]
