#[doc = "Register `BBCTRL` reader"]
pub struct R(crate::R<BBCTRL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<BBCTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<BBCTRL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<BBCTRL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `BBCTRL` writer"]
pub struct W(crate::W<BBCTRL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<BBCTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<BBCTRL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<BBCTRL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type BBEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, BBCTRL_SPEC, bool, O>;
...
pub type CLDIR_W<'a, const O: u8> = crate::BitWriter<'a, u32, BBCTRL_SPEC, bool, O>;
...
pub type DADIR_W<'a, const O: u8> = crate::BitWriter<'a, u32, BBCTRL_SPEC, bool, O>;
...
pub type BBCLK_W<'a, const O: u8> = crate::BitWriter<'a, u32, BBCTRL_SPEC, bool, O>;
...
pub type BBDAT_W<'a, const O: u8> = crate::BitWriter<'a, u32, BBCTRL_SPEC, bool, O>;
...
pub type BBCLKI_W<'a, const O: u8> = crate::BitWriter<'a, u32, BBCTRL_SPEC, bool, O>;
...
pub type BBDATI_W<'a, const O: u8> = crate::BitWriter<'a, u32, BBCTRL_SPEC, bool, O>;
impl R {
...
#[doc = "Bit-Bang Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [bbctrl](index.html) module"]
pub struct BBCTRL_SPEC;
impl crate::RegisterSpec for BBCTRL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [bbctrl::R](R) reader structure"]
impl crate::Readable for BBCTRL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [bbctrl::W](W) writer structure"]
impl crate::Writable for BBCTRL_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets BBCTRL to value 0x60"]
impl crate::Resettable for BBCTRL_SPEC {
    #[inline(always)]
