...
pub type CLK_SRC_R = crate::BitReader<CLK_SRCSELECT_A>;
...
pub enum CLK_SRCSELECT_A {
    #[doc = "0: Baud Clock is derived from one of the two internal clock sources"]
    INTERNAL = 0,
    #[doc = "1: Baud Clock is derived from an external clock source"]
    EXTERNAL = 1,
}
impl From<CLK_SRCSELECT_A> for bool {
    #[inline(always)]
    fn from(variant: CLK_SRCSELECT_A) -> Self {
        variant as u8 != 0
    }
}
impl CLK_SRC_R {
    ...
    #[inline(always)]
    pub fn variant(&self) -> CLK_SRCSELECT_A {
        match self.bits {
            false => CLK_SRCSELECT_A::INTERNAL,
            true => CLK_SRCSELECT_A::EXTERNAL,
        }
    }
    #[doc = "Checks if the value of the field is `INTERNAL`"]
    #[inline(always)]
    pub fn is_internal(&self) -> bool {
        *self == CLK_SRCSELECT_A::INTERNAL
    }
    #[doc = "Checks if the value of the field is `EXTERNAL`"]
    #[inline(always)]
    pub fn is_external(&self) -> bool {
        *self == CLK_SRCSELECT_A::EXTERNAL
    }
}
...
pub type CLK_SRC_W<'a, const O: u8> = crate::BitWriter<'a, u8, CFG_SEL_SPEC, CLK_SRCSELECT_A, O>;
impl<'a, const O: u8> CLK_SRC_W<'a, O> {
    #[doc = "Baud Clock is derived from one of the two internal clock sources"]
    #[inline(always)]
    pub fn internal(self) -> &'a mut W {
        self.variant(CLK_SRCSELECT_A::INTERNAL)
    }
    #[doc = "Baud Clock is derived from an external clock source"]
    #[inline(always)]
    pub fn external(self) -> &'a mut W {
        self.variant(CLK_SRCSELECT_A::EXTERNAL)
    }
}
