...
pub type MEM_WR_DONE_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_STS_SPEC, bool, O>;
...
pub type MEM_RD_DONE_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_STS_SPEC, bool, O>;
...
pub type MEM_WR_BUSY_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_STS_SPEC, bool, O>;
...
pub type MEM_RD_BUSY_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_STS_SPEC, bool, O>;
...
pub type SREG_TRANS_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_STS_SPEC, bool, O>;
#[doc = "Field `POLL_HIGH` reader - If this bit is set, then something in the high 16-bit of status register is set and needs to be checked. SPI Master should take action to clear this."]
pub type POLL_HIGH_R = crate::BitReader<bool>;
#[doc = "Field `POLL_HIGH` writer - If this bit is set, then something in the high 16-bit of status register is set and needs to be checked. SPI Master should take action to clear this."]
pub type POLL_HIGH_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_STS_SPEC, bool, O>;
...
pub type RXF_EMP_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_STS_SPEC, bool, O>;
...
pub type RXF_FUL_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_STS_SPEC, bool, O>;
...
pub type TXF_EMP_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_STS_SPEC, bool, O>;
...
pub type TXF_FUL_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_STS_SPEC, bool, O>;
...
pub type TMCLK_CNT_ERR_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_STS_SPEC, bool, O>;
...
pub type IBF_FLG_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_STS_SPEC, bool, O>;
...
pub type OBF_FLG_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_STS_SPEC, bool, O>;
...
pub type SPIM_RST_REQ_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_STS_SPEC, bool, O>;
...
pub type RXF_RST_DN_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_STS_SPEC, bool, O>;
...
pub type TXF_RST_DN_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_STS_SPEC, bool, O>;
...
pub type OOL0_ERR_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_STS_SPEC, bool, O>;
...
pub type OOL1_ERR_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_STS_SPEC, bool, O>;
...
pub type ARMBUS_ERR_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_STS_SPEC, bool, O>;
...
pub type UNDEF_CMD_ERR_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_STS_SPEC, bool, O>;
...
pub type DV_BUSY_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_STS_SPEC, bool, O>;
...
pub type RXF_SIZE_ERR_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_STS_SPEC, bool, O>;
...
pub type TXF_UNFLW_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_STS_SPEC, bool, O>;
...
pub type TXF_OVRFLW_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_STS_SPEC, bool, O>;
...
pub type RXF_UNFLW_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_STS_SPEC, bool, O>;
...
pub type RXF_OVRFLW_W<'a, const O: u8> = crate::BitWriter<'a, u32, SPI_STS_SPEC, bool, O>;
impl R {
    ...
    #[inline(always)]
    pub fn poll_high(&self) -> POLL_HIGH_R {
        POLL_HIGH_R::new(((self.bits >> 6) & 1) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 6 - If this bit is set, then something in the high 16-bit of status register is set and needs to be checked. SPI Master should take action to clear this."]
    #[inline(always)]
    pub fn poll_high(&mut self) -> POLL_HIGH_W<6> {
        POLL_HIGH_W::new(self)
    }
    #[doc = "Bit 8 - Signifies all Memory write transactions for the SPI Masters requested size have been performed. New transactions are allowed."]
    #[inline(always)]
...
#[doc = "`reset()` method sets SPI_STS to value 0x0500"]
