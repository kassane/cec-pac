...
#[doc = "Field `TEST` reader - This bit must be programmed to 0h for proper operation of the device."]
pub type TEST_R = crate::BitReader<bool>;
#[doc = "Field `TEST` writer - This bit must be programmed to 0h for proper operation of the device."]
pub type TEST_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPIO_BANK_PWR_SPEC, bool, O>;
#[doc = "Field `VTR_LVL2` reader - Voltage value on VTR2. This bit is set by Firmware after a VTR Power On Reset. It must be set by software if the VTR power rail is not active when RESET_SYS is de-asserted. Write access is determined by bit 7. 1=VTR2 is powered by 1.8V 0=VTR2 is powered by 3.3V."]
pub type VTR_LVL2_R = crate::BitReader<bool>;
#[doc = "Field `VTR_LVL2` writer - Voltage value on VTR2. This bit is set by Firmware after a VTR Power On Reset. It must be set by software if the VTR power rail is not active when RESET_SYS is de-asserted. Write access is determined by bit 7. 1=VTR2 is powered by 1.8V 0=VTR2 is powered by 3.3V."]
...
and GPIO Bank Power Lock bit are R/W 1 = VTR_LEVEL bits\\[2:0\\]
...
impl R {
    #[doc = "Bit 0 - This bit must be programmed to 0h for proper operation of the device."]
    #[inline(always)]
    pub fn test(&self) -> TEST_R {
        TEST_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Voltage value on VTR2. This bit is set by Firmware after a VTR Power On Reset. It must be set by software if the VTR power rail is not active when RESET_SYS is de-asserted. Write access is determined by bit 7. 1=VTR2 is powered by 1.8V 0=VTR2 is powered by 3.3V."]
    #[inline(always)]
