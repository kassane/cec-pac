...
#[doc = "Field `VBAT_RAM_LOCK` reader - VBAT RAM LOCK bit. 0 = Not Locked. 1 = Locked."]
pub type VBAT_RAM_LOCK_R = crate::BitReader<bool>;
#[doc = "Field `VBAT_RAM_LOCK` writer - VBAT RAM LOCK bit. 0 = Not Locked. 1 = Locked."]
pub type VBAT_RAM_LOCK_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTP_LOCK_SPEC, bool, O>;
#[doc = "Field `VBAT_REG_LOCK` reader - VBAT REG LOCK. 0 = Not Locked. 1 = Locked."]
pub type VBAT_REG_LOCK_R = crate::BitReader<bool>;
#[doc = "Field `VBAT_REG_LOCK` writer - VBAT REG LOCK. 0 = Not Locked. 1 = Locked."]
pub type VBAT_REG_LOCK_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTP_LOCK_SPEC, bool, O>;
#[doc = "Field `SCUR_MBX_LOCK` reader - Secure Mailbox LOCK. 0 = Not Locked. 1 = Write Locked."]
pub type SCUR_MBX_LOCK_R = crate::BitReader<bool>;
#[doc = "Field `SCUR_MBX_LOCK` writer - Secure Mailbox LOCK. 0 = Not Locked. 1 = Write Locked."]
pub type SCUR_MBX_LOCK_W<'a, const O: u8> = crate::BitWriter<'a, u32, OTP_LOCK_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0 - Test"]
    #[inline(always)]
    ...
    #[doc = "Bit 1 - VBAT RAM LOCK bit. 0 = Not Locked. 1 = Locked."]
    #[inline(always)]
    pub fn vbat_ram_lock(&self) -> VBAT_RAM_LOCK_R {
        VBAT_RAM_LOCK_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - VBAT REG LOCK. 0 = Not Locked. 1 = Locked."]
    #[inline(always)]
    pub fn vbat_reg_lock(&self) -> VBAT_REG_LOCK_R {
        VBAT_REG_LOCK_R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 8 - Secure Mailbox LOCK. 0 = Not Locked. 1 = Write Locked."]
    #[inline(always)]
    pub fn scur_mbx_lock(&self) -> SCUR_MBX_LOCK_R {
        SCUR_MBX_LOCK_R::new(((self.bits >> 8) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Test"]
    ...
    #[doc = "Bit 8 - Secure Mailbox LOCK. 0 = Not Locked. 1 = Write Locked."]
    #[inline(always)]
    pub fn scur_mbx_lock(&mut self) -> SCUR_MBX_LOCK_W<8> {
        SCUR_MBX_LOCK_W::new(self)
    }
